...
const AnimatedText = () => {
    ...
    return (
        <div className="md:h-[85vh] flex flex-col justify-center items-center py-5">
            <p ref={el => textRefs.current[0] = el} className="md:text-[2.5rem] text-xl leading-snug font-bold">
