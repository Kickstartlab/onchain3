    ...
    <header>
      ...
      <div className="lg:hidden flex items-center justify-between py-6">
        ...
        <button onClick={ToggleSidebar} className="nav cursor-pointer">
          {isOpen ? (
            <svg className='transition-all duration-400' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
